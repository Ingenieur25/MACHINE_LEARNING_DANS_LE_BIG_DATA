...
input_dir = "C:/laragon/www/html/ProcessedLogs"  # Change this path as needed
output_dir = "C:/laragon/www/html/output"  # Change this path as needed
...
print("Data aggregation and output creation completed successfully!")
